.386
	...
	PUBLIC  resetmouse
        PUBLIC  showcursor, hidecursor, mousestatus, setcursorpos
	PUBLIC  getbtnpressinfo, getbtnreleaseinfo, setboundaries
	PUBLIC  setgraphicscursor, getsensitivity, setsensitivity
	
ProtCode SEGMENT PARA PUBLIC USE32
